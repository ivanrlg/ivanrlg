...
**Senior Functional & Technical Consultant** specializing in Dynamics 365 Business Central at a Microsoft Partner. Systems Engineer with 10+ years in the Microsoft Dynamics ecosystem (NAV/BC), certified MB-800 and MB-820. I build ERP extensions in AL, design BC APIs and business logic for mobile-connected solutions, and integrate with Azure OpenAI/Copilot.
...
- 📱 Architecting BC backend modules and APIs for mobile-connected ERP solutions: WMS, sales, payments, manufacturing, and reporting.
...
|---------|-------------|-------|
| **Plur-e** *(Built at MS Cloud Experts)* | Architecture and full BC backend for a mobile-connected ERP extension: WMS (License Plates, basic/advanced warehousing), sales, payments, manufacturing, and reporting modules. Designed all Business Central APIs and business logic consumed by the mobile app and external systems. 5+ years of continuous development. | AL, Web Services, REST APIs |
| **Plur-e AI** *(Built at MS Cloud Experts)* | AI-powered chatbots for Business Central using Azure OpenAI: delivery route optimization, automated business process assistance, and intelligent reporting. | AL, Azure OpenAI |
...
| **SmartHydro** | IoT system with Arduino for water tank automation, flow detection, and consumption accounting. Telemetry integrated with Business Central via Azure IoT Hub and Azure Functions. | Arduino, Azure IoT Hub, Azure Functions |
